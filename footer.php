                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-7">
                            <div class="copyright">
                                <p>Copyright © 2022 <a href="#">Online Food Ordering</a>. All Right Reserved.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-5">
                            <div class="footer-social">
                                <ul>
                                    <li><a href="https://www.facebook.com/bera.vandit/"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/vandit_bera_"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/vandit.bera/"><i class="ion-social-instagram-outline"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/vandit-bera-4a0b02221/"><i class="ion-social-linkedin"></i></a></li>
                                    <li><a href="https://github.com/vandit-bera"><i class="ion-social-github"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
